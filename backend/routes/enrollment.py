...
async def check_enrollment_route(
    ...
    enrolled = await check_enrollment(current_user["username"], plan_id)
...
async def get_my_enrollments(
    ...
    return await get_user_enrollments(current_user["username"])
...
async def get_course_access_route(
    ...
    return await get_course_access(tool_id, authorization)
