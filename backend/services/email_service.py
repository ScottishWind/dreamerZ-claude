...
def build_password_reset_email(username: str, reset_link: str) -> str:
    """HTML body for a password-reset request."""
    return f"""<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  <title>Reset your DreamerZ password</title>
</head>
<body style="margin:0; padding:0; background:#f8fafc; font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif; color:#0f172a;">
  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background:#f8fafc;">
    <tr>
      <td align="center" style="padding:40px 16px;">
        <table role="presentation" width="560" cellspacing="0" cellpadding="0" style="max-width:560px; background:#ffffff; border-radius:16px; box-shadow:0 1px 3px rgba(15,23,42,0.05); overflow:hidden;">
          <tr>
            <td style="padding:32px 40px 8px 40px;">
              <h1 style="margin:0 0 8px 0; font-size:22px; line-height:1.3; color:#0f172a;">Reset your password</h1>
              <p style="margin:0; color:#475569; font-size:15px; line-height:1.6;">
                Hi {username}, we received a request to reset the password on your DreamerZ account.
              </p>
            </td>
          </tr>
          <tr>
            <td style="padding:24px 40px;">
              <a href="{reset_link}" style="display:inline-block; background:#6366f1; color:#ffffff; text-decoration:none; padding:12px 24px; border-radius:10px; font-weight:600; font-size:15px;">
                Reset password
              </a>
          ...
          <tr>
            <td style="padding:8px 40px 32px 40px;">
              <p style="margin:0; color:#94a3b8; font-size:12px; line-height:1.6;">
                This link expires in 1 hour and can be used once. If you didn't request a reset, you can ignore this email — your password stays unchanged.
              </p>
            </td>
          </tr>
        </table>
...
def send_password_reset_email(to_email: str, username: str, reset_link: str) -> bool:
    ...
    html = build_password_reset_email(username, reset_link)
    return send_email(
        to_email=to_email,
