      ...
      try {
        ...
        Object.entries(changesByFile).forEach(([fileName, fileChanges]) => {
          ...
          try {
            ...
            execSync(`git -c user.name="dreamerz-visual-edit" -c user.email="noreply@dreamerz.app" add "${targetFile}"`);
            execSync(`git -c user.name="dreamerz-visual-edit" -c user.email="noreply@dreamerz.app" commit -m "visual_edit_${timestamp}"`);
          } catch (gitError) {
